...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    // Using the access key mentioned in conversation history
    formData.append("access_key", "f9f7a7a1-8d4e-4e1a-8c1a-7b8c9d0e1f20"); // Note: User needs to insert their actual key if this is a placeholder
  ...
  return (
    <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-black text-center mb-16 dark:text-white">Get In Touch</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3">
            <form onSubmit={onSubmit} className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
              ...
              <button 
                type="submit" 
                className="w-full md:w-auto px-8 py-3 bg-primary text-white font-bold rounded-xl hover:bg-red-700 transition-all shadow-lg hover:shadow-primary/30 flex items-center justify-center space-x-2"
              >
              ...
              {result && (
                <div className={`mt-4 p-3 rounded-lg text-center font-bold ${result.includes('Success') ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'}`}>
                  {result}
                </div>
              )}
            </form>
          ...
          <div className="lg:w-1/3 space-y-8">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 flex items-start space-x-4">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">+216 51 790 223</p>
              </div>
            </div>
